...
export type WsEnvelope<TType extends string, TPayload> = {
  ...
  type: TType;
  requestId?: string; // client-generated, echoed in acks/errors
  payload: TPayload;
};
...
export type C2S =
  ...
  | WsEnvelope<
    ...
    {
      roomId: RoomId;
      contentId: string; // e.g. url, youtube id, mp4 url
...
export function isClientEvent(msg: unknown): msg is C2S {
